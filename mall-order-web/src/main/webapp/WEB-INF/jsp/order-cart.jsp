...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="https://owwang.com/images/mall/owwang-mall-logo.png" alt="欧文购物网"></a></div>
</div>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">马云</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">浙江省杭州市滨江区</div>
						<div class="adr-m" limit="30">网商路699号</div>
